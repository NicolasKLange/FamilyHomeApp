...
class _PharmacyState extends State<Pharmacy> {
  ...
  final String category = "Farmácia";
  ...
  void getOnTheLoad() async {
    ...
    if (familyId != null) {
      setState(() {
        todoStream = _databaseMethods.getProducts(familyId, "Farmácia");
      });
    }
  }
  ...
  void addProduct(String productName) async {
    ...
    if (familyId != null) {
      ...
      await _databaseMethods.addProduct(familyId, "Farmácia", productData, id);
    }
  }
  ...
  void deleteShoppingList() async {
    String? familyId = await _databaseMethods.getFamilyId();
    if (familyId != null) {
      await _databaseMethods.deleteProductList(familyId, "Farmácia");
      setState(() {
