...
class _SchoolState extends State<School> {
  ...
  final String category = "Escola"; // Define a categoria
  ...
  void getOnTheLoad() async {
    ...
    if (familyId != null) {
      setState(() {
        todoStream = _databaseMethods.getProducts(familyId, "Escola");
      });
    }
  }
  ...
  Future openBox() => showDialog(
    ...
    if (familyId != null) {
      ...
      await _databaseMethods.addProduct(
          familyId, "Escola", productData, id);
    }
  }
  ...
  void deleteShoppingList() async {
    String? familyId = await _databaseMethods.getFamilyId();
    if (familyId != null) {
      await _databaseMethods.deleteProductList(familyId, "Escola");
      setState(() {
